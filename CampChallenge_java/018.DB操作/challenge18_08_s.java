 ...
 */
@WebServlet(urlPatterns = {"/challenge18_08_s"})
public class challenge18_08_s extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String na = request.getParameter("search");
            
            out.print(na + "様を検索<br>");
            ...
            if("".equals(na)){
                ...
                try {
                    ...
                    while(db_data.next()){
                        ...
                        out.println("プロフィールIDは" + profilesID + "　名前は" + name + "　電話番号は" + tell + "　年齢は" + age + "　誕生日は" + birthday);
                    }
