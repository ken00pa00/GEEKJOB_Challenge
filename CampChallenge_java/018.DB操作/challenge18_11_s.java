 ...
 */
@WebServlet(urlPatterns = {"/challenge18_11_s"})
public class challenge18_11_s extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String bi = request.getParameter("birthday");
            ...
            try {
                ...
                db_st.setInt(3, Integer.parseInt(ag));
                db_st.setString(4, bi);
                db_st.setInt(5, Integer.parseInt(id));
